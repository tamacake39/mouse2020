...
#define PULSE_SLA_R90 \
    216  //半区画右90度スラローム用パルス数・加減速のために半分の値
#define PULSE_SLA_L90 \
    216  //半区画左90度スラローム用パルス数・加減速のために半分の値
#define PULSE_SLA_PRE 60  //半区画左90度スラローム用パルス数

//加減速それぞれやるために半分の値で代入
#define PULSE_SETPOS_BACK 125  //後ろ壁に当てるために下がるパルス数/2
#define PULSE_SETPOS_SET 51  //後ろ壁から中央までのパルス数/2

//----テーブルカウンタ関連----
#define MAX_T_CNT 8191                //テーブルカウンタの最大値
